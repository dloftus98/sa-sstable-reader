...
public class ReadInSsTable {
	...
	public static void main(String[] args) throws IOException {
		String directory = "/Users/dloftus/workspace/databus/sstables";
		System.setProperty("cassandra.config", "file:///Users/dloftus/workspace/databus/sstables/cassandra.yaml");
...
//		}
	...
	private static void serializeColumns(SSTableIdentityIterator columns, PrintStream out, AbstractType<?> comparator, CFMetaData cfMetaData, Key k, RowCounter c, String fileName) {
		RowFrag frag = new RowFrag(fileName);
        while (columns.hasNext())
        {
            String col = serializeColumn(columns.next(), comparator, cfMetaData, out, k, c);
                       //serializeColumn(IColumn column, AbstractType<?> comparator, CFMetaData cfMetaData, PrintStream out, Key k, RowCounter c)
